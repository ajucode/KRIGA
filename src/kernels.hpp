 ...
 */
// Linear
inline double kf_lin( const double& h, const double& alpha = 1.0 ) {
  return alpha * h;
}


// Square
inline double kf_sqr( const double& h, const double& alpha = 1.0 ) {
  return alpha * h * h;
}
...
// Thin plate spline
inline double kf_tpspline( const double& h, const double& R = 1.0 ) {
